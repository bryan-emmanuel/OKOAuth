...
/**
 Created by bemmanuel on 7/5/15.
 */
@RunWith(PowerMockRunner.class)
@PrepareForTest({ TextUtils.class, Base64.class })
@PowerMockIgnore({ "javax.crypto.*" })
public class RequestTokenRequestBuilderTest extends TestCase {
    ...
    public void setUp() throws Exception {
        ...
        // create Request
        mRequest = new RequestTokenRequestBuilder(CONSUMER_KEY, CONSUMER_SECRET, CALLBACK_URL)
                .url(REQUEST_URL)
                .build();
    }
